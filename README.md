...
#
# 1) Revisar gramática
# 2) Revisar subclases morfológicas en función de los rasgos que vaya a tener la gramática
# 3) Revisar el script en función de eso
# 4) Todo lo que hay subido ahora es para una gramática no eventiva, si vamos a asumir una eventiva, hay que adaptar todo eso a una semántica de ese tipo.
